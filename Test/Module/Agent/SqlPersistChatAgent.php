...
/**
 * SQL 持久化多轮会话 Agent —— 在 chatHistory() 中使用 Neuron SQLChatHistory。
 *
 * 表结构见 Neuron SQLChatHistory（chat_history：thread_id + messages JSON）。
 *
...
final class SqlPersistChatAgent extends Agent
{
    ...
    protected function instructions(): string
    {
        return (string) new SystemPrompt(
            background: [
                'You are a helpful assistant with persistent conversation memory.',
